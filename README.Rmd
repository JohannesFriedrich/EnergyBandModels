...
For my PhD I wanted a uniform design of my graphics. I used a lot of energy-band models, so I decided to develop a graphical output with [ggplot2](https://ggplot2.tidyverse.org). Here I present the usage for anyone else who is interested in.
...
Now we add electrons to the conduction band and holes are created in the valence band.
